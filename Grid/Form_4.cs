...
namespace Grid
{
    ...
    {
        public Form_4(double[,] f, List<Dictionary<double, double>> d_list)
        {
            InitializeComponent();
        ...
        private void DrawGraph(double[,] f, List<Dictionary<double, double>> d_list)
        {
            ...
            {
                LineItem dCurve = pane.AddCurve("d(x)", l, Color.Red, SymbolType.None);
            }
